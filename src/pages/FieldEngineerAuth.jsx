            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full pl-4 pr-10 py-3 border-2 border-slate-200 rounded-xl focus:outline-none focus:border-teal-600 focus:ring-2 focus:ring-teal-100 transition text-sm"
                  disabled={loading}
                />
                <button
                  type="button"
